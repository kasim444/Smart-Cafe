...
<?php } else { ?><?php
	...
	<div style="padding-top:25px;">        
        ...
        <a class="btn btn-circle btn-raised ripple-effect btn-default" id="checkout" href="checkout.php" style="background:linear-gradient(35deg,#2bbbad,#0069ff);"> Siparişi Tamamla</a>
	</div>
	</center>
<?php }
