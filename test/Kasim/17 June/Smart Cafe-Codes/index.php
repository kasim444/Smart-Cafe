...
<center>
      ...
      ?>
        <div>
        <input style="width: 25%; height: 5%; border-radius: 5px;" type="text" class="form-control" placeholder="Kullanıcı adınızı giriniz." name="username" required />
        <span></span>
        </div>


        <div>
        <input style="width: 25%; height: 5%; border-radius: 5px;" type="password" class="form-control" placeholder="Şifrenizi giriniz." name="password" required />
        </div>
      ...
      <hr />
            ...
            <br>
            <br>
            <a id="signup" href="register.php" class="btn btn-default">Bir hesabınız yok mu ? Buraya tıklayarak üye olabilirsiniz !</a>
