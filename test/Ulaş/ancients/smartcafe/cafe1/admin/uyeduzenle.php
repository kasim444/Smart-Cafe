...
//kayıt silme kodu başlangıcı
	...
	{
		$id=$_POST["id"];
		$sqlsil=mysql_query("delete from cafeler where id='$id'");
...
//kayıt düzenle kod başlangıcı
	if(@$_POST["btnduzenle"]=="Düzenle")
	{
		...
		$ilce=$_POST["ilce"];
		$tel=$_POST["tel"];
		@$sqlduzenle=mysql_query("update cafeler set cafeadi='$cafeadi',ipno='$ipno', sehir='$sehir', ilce='$ilce',tel='$tel' where id='$id'");
