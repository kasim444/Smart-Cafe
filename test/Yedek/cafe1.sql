...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 10 Haz 2018, 15:09:54
...
--
-- Tablo döküm verisi `usr73`
--

INSERT INTO `usr73` (`urun_id`, `urun_adi`, `adet`, `birim_fiyat`, `toplam`) VALUES
(11, 'Ayran', 1, 5, 5),
(12, 'Fanta', 1, 5, 5);
...
--
-- Tablo döküm verisi `usr77`
--

INSERT INTO `usr77` (`urun_id`, `urun_adi`, `adet`, `birim_fiyat`, `toplam`) VALUES
(10, 'Kemal Paşa', 1, 10, 10),
(11, 'Ayran', 1, 5, 5),
(12, 'Fanta', 3, 5, 15);
...
--
-- Tablo döküm verisi `usr80`
--

INSERT INTO `usr80` (`urun_id`, `urun_adi`, `adet`, `birim_fiyat`, `toplam`) VALUES
(12, 'Fanta', 1, 5, 5);

-- --------------------------------------------------------

--
-- Tablo için tablo yapısı `usr81`
--
...
--
-- Tablo döküm verisi `usr85`
--

INSERT INTO `usr85` (`urun_id`, `urun_adi`, `adet`, `birim_fiyat`, `toplam`) VALUES
(10, 'Kemal Paşa', 1, 10, 10),
(12, 'Fanta', 1, 5, 5);
...
--
-- Tablo için indeksler `usr63`
--
ALTER TABLE `usr63`
  ADD PRIMARY KEY (`urun_id`);

--
-- Tablo için indeksler `usr64`
--
ALTER TABLE `usr64`
  ADD PRIMARY KEY (`urun_id`);
...
--
-- Tablo için indeksler `usr66`
--
ALTER TABLE `usr66`
  ADD PRIMARY KEY (`urun_id`);

--
-- Tablo için indeksler `usr67`
--
ALTER TABLE `usr67`
  ADD PRIMARY KEY (`urun_id`);
...
--
-- Tablo için indeksler `usr77`
--
ALTER TABLE `usr77`
  ADD PRIMARY KEY (`urun_id`);

--
-- Tablo için indeksler `usr80`
--
ALTER TABLE `usr80`
  ADD PRIMARY KEY (`urun_id`);

--
-- Tablo için indeksler `usr81`
--
ALTER TABLE `usr81`
  ADD PRIMARY KEY (`urun_id`);

--
-- Tablo için indeksler `usr83`
--
ALTER TABLE `usr83`
  ADD PRIMARY KEY (`urun_id`);

--
-- Tablo için indeksler `usr85`
--
ALTER TABLE `usr85`
  ADD PRIMARY KEY (`urun_id`);
...
--
-- Tablo için indeksler `usr92`
--
ALTER TABLE `usr92`
  ADD PRIMARY KEY (`urun_id`);

--
-- Tablo için indeksler `usr94`
--
ALTER TABLE `usr94`
  ADD PRIMARY KEY (`urun_id`);
...
--
-- Tablo için AUTO_INCREMENT değeri `usr61`
--
ALTER TABLE `usr61`
...
--
-- Tablo için AUTO_INCREMENT değeri `usr63`
--
ALTER TABLE `usr63`
  MODIFY `urun_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- Tablo için AUTO_INCREMENT değeri `usr64`
--
ALTER TABLE `usr64`
  MODIFY `urun_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Tablo için AUTO_INCREMENT değeri `usr66`
--
ALTER TABLE `usr66`
  MODIFY `urun_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- Tablo için AUTO_INCREMENT değeri `usr67`
--
ALTER TABLE `usr67`
  MODIFY `urun_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Tablo için AUTO_INCREMENT değeri `usr77`
--
ALTER TABLE `usr77`
  MODIFY `urun_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- Tablo için AUTO_INCREMENT değeri `usr80`
--
ALTER TABLE `usr80`
  MODIFY `urun_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- Tablo için AUTO_INCREMENT değeri `usr81`
--
ALTER TABLE `usr81`
  MODIFY `urun_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- Tablo için AUTO_INCREMENT değeri `usr83`
--
ALTER TABLE `usr83`
  MODIFY `urun_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- Tablo için AUTO_INCREMENT değeri `usr85`
--
ALTER TABLE `usr85`
  MODIFY `urun_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
-- Tablo için AUTO_INCREMENT değeri `usr92`
--
ALTER TABLE `usr92`
  MODIFY `urun_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- Tablo için AUTO_INCREMENT değeri `usr94`
--
ALTER TABLE `usr94`
  MODIFY `urun_id` int(11) NOT NULL AUTO_INCREMENT;
