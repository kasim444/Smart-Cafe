...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 03 Ağu 2018, 23:09:43
...
(162, 14, '2018-07-03 12:11:34', 2),
(163, 14, '2018-07-03 13:26:22', 0);
...
(60, 161, 9, 10, 1, 10.00),
(61, 162, 7, 10, 3, 30.00),
(62, 162, 12, 10, 1, 10.00),
(63, 162, 17, 10, 2, 20.00),
(64, 162, 18, 10, 1, 10.00),
(65, 163, 8, 10, 1, 10.00),
(66, 163, 14, 5, 2, 10.00),
(67, 163, 7, 10, 1, 10.00);
...
--
ALTER TABLE `order`
  MODIFY `orderID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=164;

--
-- Tablo için AUTO_INCREMENT değeri `orderdetail`
--
ALTER TABLE `orderdetail`
  MODIFY `orderdId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;
...
--
ALTER TABLE `uyeler`
  MODIFY `uye_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
COMMIT;
